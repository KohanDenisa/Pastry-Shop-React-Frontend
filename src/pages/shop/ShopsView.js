...
export default function ShopsView() {
    ...
    return (
        <React.Fragment>
            ...
            <Pagination variant="outlined" color="secondary" count={numPages} showFirstButton showLastButton onChange={(event, selectedPage) => {setPage(selectedPage); setLoading(true)}} siblingCount={0} boundaryCount={4}/>
        </React.Fragment>
    )
}